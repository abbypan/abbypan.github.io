...
| 站点 |  推荐自用 | 稳定 | 看ytb用 | 发包测试用 | 备份用 | 跑高CPU任务 | 小任务随手测 |
| ---- |  -------- | ---- | ------- | ---------- | ------ | ----------  | ------------ |
...
| [virmach](https://virmach.com/manage/aff.php?aff=235) | 1 | 1 | 1 | 0 | 1 | 1 | 1 | 2
| [bandwagon](https://bandwagonhost.com/aff.php?aff=1132) | 2 | 2 | 1 | 0 | 0 | 0 | 0 | 3 | 3
