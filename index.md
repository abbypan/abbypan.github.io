...
| ---- | ------ | ------ | ---- |
| 2019 - now | OPPO | Security Architect | Terminal Security |
...
| IEEE TrustCom 2018 | [A Public Key based EDNS Privacy Tunnel for DNS](https://ieeexplore.ieee.org/document/8456128/) | First Author |
| IEEE PST 2018 | [Mitigating Client Subnet Leakage in DNS Queries](https://ieeexplore.ieee.org/document/8514164/) | First Author |
| NDSS DNS Privacy Workshop 2017 | [EIL: Dealing with the Privacy Problem of ECS](https://dnsprivacy.org/ndss_dns_privacy_workshop/2017_ndss_dns_privacy_workshop/) | First Author |
| IEEE APNOMS 2016 | [Mitigating DDoS Attacks towards Top Level Domain Name Service](https://ieeexplore.ieee.org/document/7737252/) | First Author |
| IEEE ISCC 2016 | [Dealing with temporary domain name issues in the DNS](https://ieeexplore.ieee.org/document/7543831/) | Co-author |
| 计算机应用研究 2016 |  [一种评估DNS根镜像服务的方法](http://www.arocmag.com/) | First Author |
| 计算机应用研究 2015 | [一种快速评估DDOS攻击对DNS权威服务影响的方法](https://coaa.istic.ac.cn/openJournal/periodicalArticle/0120160104856710) | First Author |
| 通信技术 2010 | [基于兴趣相似度的协作式垃圾邮件过滤方案](https://r.cnki.net/kcms/detail/detail.aspx?filename=TXJS201002043&dbcode=CRJT_CJFD&dbname=CJFD2010&v=) | First Author |
...
| Year | Draft | Role |
| ---- | ----- | ---- |
| IETF draft-pan-dnsop-explicit-forged-answer-signal | [Explicit Forged Answer Signal](https://datatracker.ietf.org/doc/draft-pan-dnsop-explicit-forged-answer-signal/) | First Author |
| IETF draft-pan-dnsop-edns-isp-location | [ISP Location in DNS Queries](https://datatracker.ietf.org/doc/draft-pan-dnsop-edns-isp-location/) | First Author |
| IETF draft-pan-dnsop-swild-rr-type | [SWILD RR Type (Wildcard on Intermediate Nameservers)](https://datatracker.ietf.org/doc/draft-pan-dnsop-swild-rr-type) | First Author |
